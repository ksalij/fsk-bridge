'''
Code addapted from BridgeBots libary.
'''
...
def _calculate_bonus(
    level: int, suit: str, doubled: int, vulnerable: bool, contracted_trick_score: int, overtricks: int
) -> int:
    score = 0
    # Slam bonus
    if level == 7:
...
def calculate_score(level: int, suit: str, doubled: int, tricks: int, vulnerable: bool) -> int:
    """
